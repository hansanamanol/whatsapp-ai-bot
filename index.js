// Local testing eke .env file ekakin environment variables load karanna.
// Railway wage platform ekaka mekata balapaanne na — ehema .env file ekak
// nathi nisa, dotenv silently skip wenawa, Railway ge platform-level env
// vars ma use wenawa.
